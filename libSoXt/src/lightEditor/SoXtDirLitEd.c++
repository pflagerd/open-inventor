...
// the menu items
enum {
	k_COLOR_EDITOR = 0, k_COPY, k_PASTE, k_HELP
};
...
static const char *defaults[] = { "Inten " };
...
//
SoXtDirectionalLightEditor::SoXtDirectionalLightEditor(Widget parent,
...
// private
//
void SoXtDirectionalLightEditor::constructorCommon(SbBool buildNow)
//
//////////////////////////////////////////////////////////////////////
		{
	...
	SoXtDirectionalLightEditor::lightSensorCB);lightSensor
	->setData((void *) this);
	...
	SoXtDirectionalLightEditor::cameraSensorCB);cameraSensor
	->setData((void *) this);
	cameraToWatch = NULL;
...
void SoXtDirectionalLightEditor::show() {
	SoXtComponent::show();
...
void SoXtDirectionalLightEditor::hide() {
	SoXtComponent::hide();
	if (colorEditor != NULL)
		colorEditor->hide();
}
...
// usage: private
//
Widget SoXtDirectionalLightEditor::buildPulldownMenu(Widget parent)
//
////////////////////////////////////////////////////////////////////////
		{
	...
	pulldown = XmCreatePulldownMenu(menubar, (char*)"controlPulldown", NULL, 0);

	n = 0;
	XtSetArg(args[n], XmNsubMenuId, pulldown);
	n++;
	buttons[0] = XtCreateWidget((char*)"Edit", xmCascadeButtonGadgetClass, menubar,
			args, n);
...
#define PUSH_ITEM(NAME,KONST) \
	...
	menuW[num++] = XtCreateWidget((char*)"separator", xmSeparatorGadgetClass, pulldown,
			NULL, 0);
...
//
Widget SoXtDirectionalLightEditor::buildWidget(Widget parent)
//
////////////////////////////////////////////////////////////////////////
		{
	Widget menubar;
	...
	intensitySlider = new _SoXtColorSlider(widget, NULL, TRUE,
			_SoXtColorSlider::INTENSITY_SLIDER);
	...
	XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET);
	n++;
	XtSetArg(args[n], XmNtopWidget, renderArea->getWidget());
	n++;
...
////////////////////////////////////////////////////////////////////////
	...
	if (fullPathToLight->getTail()->isOfType(
		...
		if (sa.getPath() != NULL) {
			cameraToWatch =
					(SoCamera *) ((SoFullPath *) sa.getPath())->getTail();
			cameraToWatch->ref();
			...
			if (renderArea != NULL) {
				myCamera->viewAll(litStuff,
						SbViewportRegion(renderArea->getSize()), 2.0);// slack = 2.0
			}
		}
...
//
void SoXtDirectionalLightEditor::colorEditorCB(void *p, const SbColor *rgb)
//
////////////////////////////////////////////////////////////////////////
		{
...
// usage: static, private
//
void SoXtDirectionalLightEditor::intensitySliderCB(void *p, float intensity)
//
////////////////////////////////////////////////////////////////////////
		{
	SoXtDirectionalLightEditor *editor = (SoXtDirectionalLightEditor *) p;
...
//  Use: private
//
void SoXtDirectionalLightEditor::updateLocalComponents()
//
////////////////////////////////////////////////////////////////////////
{
	if (colorEditor != NULL) {
	...
	if (intensitySlider != NULL) {
		...
		intensitySlider->setBaseColor(
				dirLightManip->color.getValue().getValue());
		ignoreCallback = FALSE;
	}
}
...
//  Use: public
//
void SoXtDirectionalLightEditor::setLight(const SoDirectionalLight &newValues)
//
////////////////////////////////////////////////////////////////////////
		{
	if (dirLight != NULL) {
...
//  Use: private
//
void SoXtDirectionalLightEditor::lightSensorCB(
		SoXtDirectionalLightEditor *editor, SoSensor *)
//
////////////////////////////////////////////////////////////////////////
		{
#ifdef DEBUG
...
//  Use: private
//
void SoXtDirectionalLightEditor::cameraSensorCB(
		SoXtDirectionalLightEditor *editor, SoSensor *)
//
////////////////////////////////////////////////////////////////////////
		{
...
//
void SoXtDirectionalLightEditor::activate()
//
// use: private
////////////////////////////////////////////////////////////////////////
{
...
//
void SoXtDirectionalLightEditor::deactivate()
//
// use: private
////////////////////////////////////////////////////////////////////////
{
...
//  Use: private
//
void SoXtDirectionalLightEditor::menuPick(Widget w, int id,
...
////////////////////////////////////////////////////////////////////////
	...
	case k_PASTE:
		...
		editor->clipboard->paste(eventTime,
				SoXtDirectionalLightEditor::pasteDoneCB, editor);
		break;
...
//  Use: static private
//
void SoXtDirectionalLightEditor::pasteDoneCB(void *userData,
		SoPathList *pathList)
//
////////////////////////////////////////////////////////////////////////
		{
...
//  Use: private
//
void SoXtDirectionalLightEditor::copyLight(SoDirectionalLight *dst,
...
//  Use: static private
//
void SoXtDirectionalLightEditor::dirLightManipCB(void *userData, SoDragger *)
//
////////////////////////////////////////////////////////////////////////
		{
...
//
void SoXtDirectionalLightEditor::visibilityChangeCB(void *pt, SbBool visible) {
