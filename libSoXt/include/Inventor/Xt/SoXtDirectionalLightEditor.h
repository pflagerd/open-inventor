...
typedef void SoXtDirectionalLightEditorCB(void *userData,
...
public:
	SoXtDirectionalLightEditor(Widget parent = NULL, const char *name = NULL,
	...
	inline void addLightChangedCallback(SoXtDirectionalLightEditorCB *f,
			void *userData = NULL);
	// C-api: name=removeLtChangedCB
	inline void removeLightChangedCallback(SoXtDirectionalLightEditorCB *f,
			void *userData = NULL);
...
protected:
	...
	SoEXTENDER
	SoXtDirectionalLightEditor(Widget parent, const char *name,
...
// Inline functions
void SoXtDirectionalLightEditor::addLightChangedCallback(
		SoXtDirectionalLightEditorCB *f, void *userData) {
	callbackList->addCallback((SoCallbackListCB *) f, userData);
}

void SoXtDirectionalLightEditor::removeLightChangedCallback(
		SoXtDirectionalLightEditorCB *f, void *userData) {
