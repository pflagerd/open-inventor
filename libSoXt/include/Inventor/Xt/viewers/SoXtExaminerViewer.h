...
public:
	SoXtExaminerViewer(Widget parent = NULL, const char *name = NULL,
			SbBool buildInsideParent = TRUE, SoXtFullViewer::BuildFlag flag =
...
protected:
	...
	SoXtExaminerViewer(Widget parent, const char *name,
			SbBool buildInsideParent, SoXtFullViewer::BuildFlag flag,
			SoXtViewer::Type type, SbBool buildNow);
...
private:
	...
	static void feedbackSizeWheelCB(Widget, SoXtExaminerViewer *p,
			XtPointer *d);
