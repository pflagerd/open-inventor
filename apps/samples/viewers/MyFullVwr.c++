...
enum popupChoices {
    ...
    HOME,	  // with MyViewerDrawStyle values)
    HEADLIGHT, 
    SEEK, 
    PREF, 
    VIEWING, 
...
static const char *thisClassName = "MyFullViewer";
...
MyFullViewer::MyFullViewer(
    Widget parent,
    const char *name, 
    SbBool buildInsideParent,
    MyFullViewer::BuildFlag buildFlag, 
    MyViewer::Type t, 
    SbBool buildNow) 
	: MyViewer(
	    parent,
...
////////////////////////////////////////////////////////////////////////
{
	...
	XtRemoveCallback(prefSheetShellWidget, XtNdestroyCallback,
	    (XtCallbackProc) MyFullViewer::prefSheetDestroyCB,
	    (XtPointer) this);
...
// Use: virtual public
void
MyFullViewer::setViewing(SbBool flag)
//
////////////////////////////////////////////////////////////////////////
{
    if (flag == viewingFlag)
...
// Use: virtual public
void
MyFullViewer::setHeadlight(SbBool flag)
//
////////////////////////////////////////////////////////////////////////
{
    if (flag == isHeadlight())
...
// Use: virtual public
void
MyFullViewer::setDrawStyle(MyViewer::DrawType type, 
				MyViewer::DrawStyle style)
//
////////////////////////////////////////////////////////////////////////
{
    // call base class routine
    MyViewer::setDrawStyle(type, style);
    
    // update the popup menu entries
    if (drawStyleWidgets[0]) {
	for (int i = 0; i < DRAW_STYLE_NUM; i++)
	    TOGGLE_OFF(drawStyleWidgets[i]);
	switch(getDrawStyle(MyViewer::STILL)) {
	    case MyViewer::VIEW_AS_IS: TOGGLE_ON(drawStyleWidgets[AS_IS]); break;
	    case MyViewer::VIEW_HIDDEN_LINE: TOGGLE_ON(drawStyleWidgets[HIDDEN_LINE]); break;
	    case MyViewer::VIEW_NO_TEXTURE: TOGGLE_ON(drawStyleWidgets[NO_TXT]); break;
	    case MyViewer::VIEW_LOW_COMPLEXITY: TOGGLE_ON(drawStyleWidgets[LOW_RES]); break;
	    case MyViewer::VIEW_LINE: TOGGLE_ON(drawStyleWidgets[LINE]); break;
	    case MyViewer::VIEW_POINT: TOGGLE_ON(drawStyleWidgets[POINT]); break;
	    case MyViewer::VIEW_BBOX: TOGGLE_ON(drawStyleWidgets[BBOX]); break;
	    default: break;
	}
	switch(getDrawStyle(MyViewer::INTERACTIVE)) {
	    case MyViewer::VIEW_SAME_AS_STILL: TOGGLE_ON(drawStyleWidgets[MOVE_SAME_AS]); break;
	    case MyViewer::VIEW_NO_TEXTURE: TOGGLE_ON(drawStyleWidgets[MOVE_NO_TXT]); break;
	    case MyViewer::VIEW_LOW_COMPLEXITY: TOGGLE_ON(drawStyleWidgets[MOVE_LOW_RES]); break;
	    case MyViewer::VIEW_LINE: TOGGLE_ON(drawStyleWidgets[MOVE_LINE]); break;
	    case MyViewer::VIEW_LOW_RES_LINE: TOGGLE_ON(drawStyleWidgets[MOVE_LOW_LINE]); break;
	    case MyViewer::VIEW_POINT: TOGGLE_ON(drawStyleWidgets[MOVE_POINT]); break;
	    case MyViewer::VIEW_LOW_RES_POINT: TOGGLE_ON(drawStyleWidgets[MOVE_LOW_POINT]); break;
	    case MyViewer::VIEW_BBOX: TOGGLE_ON(drawStyleWidgets[MOVE_BBOX]); break;
	    default: break;
	}
    }
}
...
// Use: virtual public
void
MyFullViewer::setBufferingType(MyViewer::BufferType type)
//
////////////////////////////////////////////////////////////////////////
{
    // call base class routine
    MyViewer::setBufferingType(type);
...
// Use: virtual public
void
MyFullViewer::setCamera(SoCamera *newCamera)
//
////////////////////////////////////////////////////////////////////////
{
    // call base class routine
    MyViewer::setCamera(newCamera);
...
// Use: public
void
MyFullViewer::setDecoration(SbBool flag)
//
////////////////////////////////////////////////////////////////////////
{
...
// Use: virtual public
void
MyFullViewer::setPopupMenuEnabled(SbBool flag)
//
////////////////////////////////////////////////////////////////////////
{
...
// Use: public
void
MyFullViewer::addAppPushButton(Widget newButton)
//
////////////////////////////////////////////////////////////////////////
{
...
// Use: public
void
MyFullViewer::insertAppPushButton(Widget newButton, int index)
//
////////////////////////////////////////////////////////////////////////
{
...
// Use: public
void
MyFullViewer::removeAppPushButton(Widget oldButton)
//
////////////////////////////////////////////////////////////////////////
{
...
// use: protected
void
MyFullViewer::setPopupMenuString(const char *str)
//
////////////////////////////////////////////////////////////////////////
{
    if (popupTitle != NULL) free(popupTitle);
...
// use: protected
void
MyFullViewer::setBottomWheelString(const char *str)
//
////////////////////////////////////////////////////////////////////////
{
    if (bottomWheelStr != NULL) free(bottomWheelStr);
...
// use: protected
void
MyFullViewer::setLeftWheelString(const char *str)
//
////////////////////////////////////////////////////////////////////////
{
    if (leftWheelStr != NULL) free(leftWheelStr);
...
// use: protected
void
MyFullViewer::setRightWheelString(const char *str)
//
////////////////////////////////////////////////////////////////////////
{
    if (rightWheelStr != NULL) free(rightWheelStr);
...
////////////////////////////////////////////////////////////////////////
{
	...
	(XtEventHandler) &MyFullViewer::popMenuCallback, (XtPointer)this);
...
#define ADD_TOGGLE(NAME, W, ID, STATE)	\
	...
	(XtCallbackProc) MyFullViewer::menuPick, (XtPointer) ID);    
...
Widget
MyFullViewer::buildFunctionsSubmenu(Widget popup)
//
////////////////////////////////////////////////////////////////////////
{
    int     n, butnum = 0;
...
Widget
MyFullViewer::buildDrawStyleSubmenu(Widget popup)
//
////////////////////////////////////////////////////////////////////////
{
    int     n, butnum = 0;
...
#define ADD_ENTRY(NAME, ID, STATE) \
	...
	(XtCallbackProc) MyFullViewer::drawStyleMenuPick, (XtPointer) ID);
    
    int drawType = getDrawStyle(MyViewer::STILL);
    ADD_ENTRY("as is", AS_IS, drawType == MyViewer::VIEW_AS_IS)
    ADD_ENTRY("hidden line", HIDDEN_LINE, drawType == MyViewer::VIEW_HIDDEN_LINE)
    ADD_ENTRY("no texture", NO_TXT, drawType == MyViewer::VIEW_NO_TEXTURE)
    ADD_ENTRY("low resolution", LOW_RES, drawType == MyViewer::VIEW_LOW_COMPLEXITY)
    ADD_ENTRY("wireframe", LINE, drawType == MyViewer::VIEW_LINE)
    ADD_ENTRY("points", POINT, drawType == MyViewer::VIEW_POINT)
    ADD_ENTRY("bounding box (no depth)", BBOX, drawType == MyViewer::VIEW_BBOX)
    
    buttons[butnum++] = XtCreateWidget((char*)"sep", xmSeparatorGadgetClass, submenu, NULL, 0);
    
    drawType = getDrawStyle(MyViewer::INTERACTIVE);
    ADD_ENTRY("move same as still", MOVE_SAME_AS, drawType == MyViewer::VIEW_SAME_AS_STILL)
    ADD_ENTRY("move no texture", MOVE_NO_TXT, drawType == MyViewer::VIEW_NO_TEXTURE)
    ADD_ENTRY("move low res", MOVE_LOW_RES, drawType == MyViewer::VIEW_LOW_COMPLEXITY)
    ADD_ENTRY("move wireframe", MOVE_LINE, drawType == MyViewer::VIEW_LINE)
    ADD_ENTRY("move low res wireframe (no depth)", MOVE_LOW_LINE, drawType == MyViewer::VIEW_LOW_RES_LINE)
    ADD_ENTRY("move points", MOVE_POINT, drawType == MyViewer::VIEW_POINT)
    ADD_ENTRY("move low res points (no depth)", MOVE_LOW_POINT, drawType == MyViewer::VIEW_LOW_RES_POINT)
    ADD_ENTRY("move bounding box (no depth)", MOVE_BBOX, drawType == MyViewer::VIEW_BBOX)
#undef ADD_ENTRY
...
#define ADD_ENTRY(NAME, ID) \
	...
	(XtCallbackProc) MyFullViewer::bufferStyleMenuPick, (XtPointer) ID);
    
    int bufType = getBufferingType();
    ADD_ENTRY("single buffer", MyViewer::BUFFER_SINGLE)
    ADD_ENTRY("double buffer", MyViewer::BUFFER_DOUBLE)
    ADD_ENTRY("interactive buffer", MyViewer::BUFFER_INTERACTIVE)
#undef ADD_ENTRY
...
// Use: private
void
MyFullViewer::getResources(SoXtResource *xr)
//
////////////////////////////////////////////////////////////////////////
{
    // Decoration
...
// functionality of a MyFullViewerManip, pop-up menu, sliders, etc.
// Builds all subwidgets, and does layout using motif
//
// Use: protected
Widget
MyFullViewer::buildWidget(Widget parent)
//
////////////////////////////////////////////////////////////////////////
{
    //
...
// Use: virtual protected
void
MyFullViewer::buildDecoration(Widget parent)
//
////////////////////////////////////////////////////////////////////////
{
    int		n;
...
// Use: protected
void
MyFullViewer::buildLeftWheel(Widget parent)
//
////////////////////////////////////////////////////////////////////////
{
    int		n;
	...
	(XtCallbackProc) MyFullViewer::leftWheelCB, (XtPointer) this);
...
// Use: virtual protected
Widget
MyFullViewer::buildLeftTrim(Widget parent)
//
////////////////////////////////////////////////////////////////////////
{
    int		n;
...
// Use: virtual protected
Widget
MyFullViewer::buildBottomTrim(Widget parent)
//
////////////////////////////////////////////////////////////////////////
{
    int		n;
	...
	(XtCallbackProc) MyFullViewer::bottomWheelCB, (XtPointer) this);
...
// Use: virtual protected
Widget
MyFullViewer::buildRightTrim(Widget parent)
//
////////////////////////////////////////////////////////////////////////
{
    int		n;
	...
	(XtCallbackProc) MyFullViewer::rightWheelCB, (XtPointer) this);
...
// Use: protected
Widget
MyFullViewer::buildViewerButtons(Widget parent)
//
////////////////////////////////////////////////////////////////////////
{
    int i, num;
...
// Use: virtual protected
void
MyFullViewer::createViewerButtons(Widget parent)
//
////////////////////////////////////////////////////////////////////////
{
    // allocate the custom buttons
    for (int i=0; i<PUSH_NUM; i++) {
	buttonList[i] = new MyBitmapButton(parent, (i == 0 || i == 1));
	Widget w = buttonList[i]->getWidget();
	XtVaSetValues(w, XmNuserData, this, NULL);
	XtAddCallback(w, XmNactivateCallback,
	    (XtCallbackProc) MyFullViewer::pushButtonCB, (XtPointer) (unsigned long) i);
...
// Use: protected
Widget
MyFullViewer::buildAppButtons(Widget parent)
//
////////////////////////////////////////////////////////////////////////
{
...
// Use: private
void
MyFullViewer::doAppButtonLayout(int start)
//
////////////////////////////////////////////////////////////////////////
{
    int	    i, num;
...
// use: protected
void
MyFullViewer::setPrefSheetString(const char *str)
//
////////////////////////////////////////////////////////////////////////
{
    if (prefSheetStr != NULL) free(prefSheetStr);
...
// Use: protected
void
MyFullViewer::createPrefSheetShellAndForm(Widget &shell, Widget &form)
//
////////////////////////////////////////////////////////////////////////
{
    Arg args[12];
...
// Use: protected
void
MyFullViewer::createDefaultPrefSheetParts(Widget widgetList[], 
				    int &num, Widget form)
//
////////////////////////////////////////////////////////////////////////
{
...
// Use: protected
void
MyFullViewer::layoutPartsAndMapPrefSheet(Widget widgetList[], 
...
// Use: protected
Widget
MyFullViewer::createSeekPrefSheetGuts(Widget parent)
//
////////////////////////////////////////////////////////////////////////
{
    Widget widgetList[6];
	...
	(XtCallbackProc) MyFullViewer::seekPrefSheetFieldCB, (XtPointer) this);
	...
	(XtCallbackProc) MyFullViewer::seekPrefSheetToggle1CB,
	(XtPointer) widgetList[5]);
    XtAddCallback(widgetList[5], XmNvalueChangedCallback, 
	(XtCallbackProc) MyFullViewer::seekPrefSheetToggle2CB,
...
// Use: protected
Widget
MyFullViewer::createSeekDistPrefSheetGuts(Widget parent)
//
////////////////////////////////////////////////////////////////////////
{
	...
	(XtCallbackProc) MyFullViewer::seekDistWheelCB, (XtPointer) this);
    seekDistWheelVal = 0;
	...
	(XtCallbackProc) MyFullViewer::seekDistFieldCB,
	(XtPointer) this);
	...
	(XtCallbackProc) MyFullViewer::seekDistPercPrefSheetToggleCB,
	(XtPointer) toggles[1]);
    XtAddCallback(toggles[1], XmNvalueChangedCallback, 
	(XtCallbackProc) MyFullViewer::seekDistAbsPrefSheetToggleCB,
	(XtPointer) toggles[0]);
...
// Use: protected
Widget
MyFullViewer::createZoomPrefSheetGuts(Widget parent)
//
////////////////////////////////////////////////////////////////////////
{
    Arg args[12];
	...
	(XtCallbackProc) &MyFullViewer::zoomSliderCB, (XtPointer) this);
	...
	(XtCallbackProc) &MyFullViewer::zoomFieldCB, 
	(XtPointer) this);
    XtAddCallback(zoomWidgets[ZOOM_RANGE_FIELD1], XmNactivateCallback, 
	(XtCallbackProc) MyFullViewer::zoomPrefSheetMinFieldCB,
	(XtPointer) this);
    XtAddCallback(zoomWidgets[ZOOM_RANGE_FIELD2], XmNactivateCallback, 
	(XtCallbackProc) MyFullViewer::zoomPrefSheetMaxFieldCB,
	(XtPointer) this);
...
// Use: protected
Widget
MyFullViewer::createClippingPrefSheetGuts(Widget dialog)
//
////////////////////////////////////////////////////////////////////////
{
    Arg args[12];
	...
	(XtCallbackProc) MyFullViewer::clipPrefSheetToggleCB, 
	(XtPointer) form);
    
    if ( !isAutoClipping() && camera)
	MyFullViewer::clipPrefSheetToggleCB(toggle, form, NULL);
...
// Use: protected
Widget
MyFullViewer::createStereoPrefSheetGuts(Widget dialog)
//
////////////////////////////////////////////////////////////////////////
{
    Arg args[12];
	...
	xmToggleButtonGadgetClass, form, args, n);
    XtAddCallback(toggle, XmNvalueChangedCallback, 
	(XtCallbackProc) MyFullViewer::stereoPrefSheetToggleCB, 
	(XtPointer) form);
    ...
    if ( isStereoViewing() )
	MyFullViewer::stereoPrefSheetToggleCB(toggle, form, NULL);
...
// Use: protected
Widget
MyFullViewer::createSpeedPrefSheetGuts(Widget parent)
//
////////////////////////////////////////////////////////////////////////
{
    Widget widgetList[3];
	...
	form, args, n);
    XtAddCallback(widgetList[1], XmNactivateCallback, 
	(XtCallbackProc) MyFullViewer::speedIncPrefSheetButtonCB,
	(XtPointer) this);
    XtAddCallback(widgetList[2], XmNactivateCallback, 
	(XtCallbackProc) MyFullViewer::speedDecPrefSheetButtonCB,
	(XtPointer) this);
...
void
MyFullViewer::setCameraZoom(float zoom)
//
////////////////////////////////////////////////////////////////////////
{
    if (camera == NULL)
	...
	SoDebugError::post("MyFullViewer::setCameraZoom",
		"unknown camera type");
#endif
}
...
#if DEBUG
	SoDebugError::post("MyFullViewer::getCameraZoom",
			    "unknown camera type");
#endif
	return 0;
    }
...
void
MyFullViewer::setZoomSliderPosition(float zoom)
//
////////////////////////////////////////////////////////////////////////
{
    if (zoomWidgets[ZOOM_SLIDER] == NULL)
...
void
MyFullViewer::setZoomFieldString(float zoom)
//
////////////////////////////////////////////////////////////////////////
{
...
//
void MyFullViewer::rightWheelStart()	    { interactiveCountInc(); }
void MyFullViewer::bottomWheelStart()	    { interactiveCountInc(); }
void MyFullViewer::leftWheelStart()	    { interactiveCountInc(); }
void MyFullViewer::rightWheelFinish()	    { interactiveCountDec(); }
void MyFullViewer::bottomWheelFinish()    { interactiveCountDec(); }
void MyFullViewer::leftWheelFinish()	    { interactiveCountDec(); }

void MyFullViewer::rightWheelMotion(float)	{}
void MyFullViewer::bottomWheelMotion(float)	{}
void MyFullViewer::leftWheelMotion(float)	{}
void MyFullViewer::openViewerHelpCard()	{}
...
void MyFullViewer::rightWheelCB(Widget, MyFullViewer *v, XtPointer *d)
{
...
void MyFullViewer::bottomWheelCB(Widget, MyFullViewer *v, XtPointer *d)
{
    SgThumbWheelCallbackStruct *data = (SgThumbWheelCallbackStruct *) d;
...
void MyFullViewer::leftWheelCB(Widget, MyFullViewer *v, XtPointer *d)
{
    SgThumbWheelCallbackStruct *data = (SgThumbWheelCallbackStruct *) d;
...
//
void
MyFullViewer::pushButtonCB(Widget w, int id, void *)
{
    MyFullViewer *v;
...
void
MyFullViewer::prefSheetDestroyCB(Widget, MyFullViewer *v, void *)
{
...
void
MyFullViewer::seekPrefSheetFieldCB(Widget field, MyFullViewer *v, void *)
{
...
void
MyFullViewer::seekPrefSheetToggle1CB(Widget tog1, Widget tog2, void *)
{
...
void
MyFullViewer::seekPrefSheetToggle2CB(Widget tog2, Widget tog1, void *)
{
...
void
MyFullViewer::seekDistPercPrefSheetToggleCB(Widget tog1, Widget tog2, void *)
{
    XmToggleButtonSetState(tog2, !XmToggleButtonGetState(tog1), FALSE);
...
void
MyFullViewer::seekDistAbsPrefSheetToggleCB(Widget tog2, Widget tog1, void *)
{
    XmToggleButtonSetState(tog1, !XmToggleButtonGetState(tog2), FALSE);
...
//
void
MyFullViewer::zoomSliderCB(Widget, MyFullViewer *v, XtPointer *d)
//
////////////////////////////////////////////////////////////////////////
{
...
//
void
MyFullViewer::zoomFieldCB(Widget field, MyFullViewer *v, XtPointer *)
//
////////////////////////////////////////////////////////////////////////
{
...
//
void
MyFullViewer::popMenuCallback(Widget, MyFullViewer *v, XEvent *event, Boolean *)
//
////////////////////////////////////////////////////////////////////////
{
    Arg args[1];
...
//
void
MyFullViewer::menuPick(Widget w, int id, XmAnyCallbackStruct *cb)
//
////////////////////////////////////////////////////////////////////////
{
...
//
void
MyFullViewer::drawStyleMenuPick(Widget w, int id, void *)
//
////////////////////////////////////////////////////////////////////////
{
    MyFullViewer *v;
    ...
    switch(id) {
	case AS_IS:	    v->setDrawStyle(MyViewer::STILL, MyViewer::VIEW_AS_IS); break;
	case HIDDEN_LINE:   v->setDrawStyle(MyViewer::STILL, MyViewer::VIEW_HIDDEN_LINE); break;
	case NO_TXT:	    v->setDrawStyle(MyViewer::STILL, MyViewer::VIEW_NO_TEXTURE); break;
	case LOW_RES:	    v->setDrawStyle(MyViewer::STILL, MyViewer::VIEW_LOW_COMPLEXITY); break;
	case LINE:	    v->setDrawStyle(MyViewer::STILL, MyViewer::VIEW_LINE); break;
	case POINT:	    v->setDrawStyle(MyViewer::STILL, MyViewer::VIEW_POINT); break;
	case BBOX:	    v->setDrawStyle(MyViewer::STILL, MyViewer::VIEW_BBOX); break;
	
	case MOVE_SAME_AS:  v->setDrawStyle(MyViewer::INTERACTIVE, MyViewer::VIEW_SAME_AS_STILL); break;
	case MOVE_NO_TXT:   v->setDrawStyle(MyViewer::INTERACTIVE, MyViewer::VIEW_NO_TEXTURE); break;
	case MOVE_LOW_RES:  v->setDrawStyle(MyViewer::INTERACTIVE, MyViewer::VIEW_LOW_COMPLEXITY); break;
	case MOVE_LINE:	    v->setDrawStyle(MyViewer::INTERACTIVE, MyViewer::VIEW_LINE); break;
	case MOVE_LOW_LINE: v->setDrawStyle(MyViewer::INTERACTIVE, MyViewer::VIEW_LOW_RES_LINE); break;
	case MOVE_POINT:    v->setDrawStyle(MyViewer::INTERACTIVE, MyViewer::VIEW_POINT); break;
	case MOVE_LOW_POINT: v->setDrawStyle(MyViewer::INTERACTIVE, MyViewer::VIEW_LOW_RES_POINT); break;
	case MOVE_BBOX:	    v->setDrawStyle(MyViewer::INTERACTIVE, MyViewer::VIEW_BBOX); break;
    }
}
...
//
void
MyFullViewer::bufferStyleMenuPick(Widget w, int id, void *)
//
////////////////////////////////////////////////////////////////////////
{
    MyFullViewer *v;
    ...
    v->setBufferingType((MyViewer::BufferType)id);
}
...
void
MyFullViewer::clipPrefSheetToggleCB(Widget toggle, Widget parent, void *)
//
////////////////////////////////////////////////////////////////////////
{
	...
	XtAddCallback(thumb[0], XmNvalueChangedCallback, 
	    (XtCallbackProc) MyFullViewer::clipNearWheelCB, (XtPointer) v);
	XtAddCallback(thumb[0], XmNdragCallback, 
	    (XtCallbackProc) MyFullViewer::clipNearWheelCB, (XtPointer) v);
	XtAddCallback(thumb[1], XmNvalueChangedCallback, 
	    (XtCallbackProc) MyFullViewer::clipFarWheelCB, (XtPointer) v);
	...
	XtAddCallback(text[0], XmNactivateCallback, 
	    (XtCallbackProc) MyFullViewer::clipFieldCB,
	    (XtPointer) v);
...
void
MyFullViewer::clipNearWheelCB(Widget, MyFullViewer *v, XtPointer *d)
{
    if (v->camera == NULL)
	return;
...
void
MyFullViewer::clipFarWheelCB(Widget, MyFullViewer *v, XtPointer *d)
{
    if (v->camera == NULL)
	return;
...
void
MyFullViewer::clipFieldCB(Widget field, MyFullViewer *v, void *)
{
    if (v->camera == NULL)
	return;
...
void
MyFullViewer::stereoPrefSheetToggleCB(Widget toggle, Widget parent, void *)
//
////////////////////////////////////////////////////////////////////////
{
    // get the viewer pointer
	...
	XtAddCallback(thumb, XmNvalueChangedCallback, 
	    (XtCallbackProc) MyFullViewer::stereoWheelCB, (XtPointer) v);
	XtAddCallback(thumb, XmNdragCallback, 
	    (XtCallbackProc) MyFullViewer::stereoWheelCB, (XtPointer) v);
	v->stereoWheelVal = 0;
	...
	v->stereoField = text = XtCreateWidget("", xmTextWidgetClass, 
	    form, args, n);
	XtAddCallback(text, XmNactivateCallback, 
	    (XtCallbackProc) MyFullViewer::stereoFieldCB,
	    (XtPointer) v);
...
void
MyFullViewer::stereoWheelCB(Widget, MyFullViewer *v, XtPointer *d)
{
    SgThumbWheelCallbackStruct *data = (SgThumbWheelCallbackStruct *) d;
...
void
MyFullViewer::stereoFieldCB(Widget field, MyFullViewer *v, void *)
{
    // get text value from the label and update camera
    char *str = XmTextGetString(field);
    float val;
...
void
MyFullViewer::seekDistWheelCB(Widget, MyFullViewer *v, XtPointer *d)
{
    SgThumbWheelCallbackStruct *data = (SgThumbWheelCallbackStruct *) d;
...
void
MyFullViewer::seekDistFieldCB(Widget field, MyFullViewer *v, void *)
{
    // get text value from the label
    char *str = XmTextGetString(field);
    float val;
...
void
MyFullViewer::zoomPrefSheetMinFieldCB(Widget field, MyFullViewer *v, void *)
{
    // get text value from the label
    char *str = XmTextGetString(field);
    float val;
...
void
MyFullViewer::zoomPrefSheetMaxFieldCB(Widget field, MyFullViewer *v, void *)
{
...
void
MyFullViewer::speedIncPrefSheetButtonCB(Widget, MyFullViewer *p, void *)
{ p->viewerSpeed *= 2.0; }

void
MyFullViewer::speedDecPrefSheetButtonCB(Widget, MyFullViewer *p, void *)
{ p->viewerSpeed /= 2.0; }
