...
typedef void MyViewerCB(void *userData, MyViewer *viewer);
...
class MyViewer : public SoXtRenderArea {
  public:
    ...
    //
    // Note: Refer to the MyViewer man pages for a complete 
    ...
    //
    // Refer to the MyViewer man pages for a complete description 
    ...
    MyViewer::DrawStyle getDrawStyle(MyViewer::DrawType type);
    ...
    MyViewer::BufferType getBufferingType()	    { return bufferType; }
 ...
 private:
    ...
    void		setCurrentDrawStyle(MyViewer::DrawStyle style);
    void		doRendering();
    ...
    static void		drawStyleStartCallback(void *, MyViewer *v);
    static void		drawStyleFinishCallback(void *, MyViewer *v);
    static void		bufferStartCallback(void *, MyViewer *v);
    static void		bufferFinishCallback(void *, MyViewer *v);
