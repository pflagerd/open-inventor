...
SoSFTime *MyViewer::viewerRealTime = NULL;
...
////////////////////////////////////////////////////////////////////////
{
    ...
    viewerSpeed = 1.0;	// default. MyFullViewer add UI to increase/decrease 
    ...
    detailSeekFlag = TRUE;
    seekAnimTime = 2.0;
    seekAnimationSensor = new SoFieldSensor(MyViewer::seekAnimationSensorCB, this);
    ...
    addStartCallback(MyViewer::drawStyleStartCallback);
    addFinishCallback(MyViewer::drawStyleFinishCallback);
...
//
void
MyViewer::setSceneGraph(SoNode *newScene)
//
////////////////////////////////////////////////////////////////////////
{
	...
	if ( newCamera == NULL ) {
	    ...
	    if (newCamera == NULL) {
#ifdef DEBUG
		SoDebugError::post("MyViewer::setSceneGraph",
		    "unknown camera type!");
#endif
...
// Use: virtual public
void
MyViewer::setCamera(SoCamera *newCamera)
//
////////////////////////////////////////////////////////////////////////
{
	...
	// scene graph.
    	if (createdCamera && type == MyViewer::BROWSER) {
...
// Use: virtual public
void
MyViewer::setCameraType(SoType type)
//
////////////////////////////////////////////////////////////////////////
{
	...
	SoDebugError::post("MyViewer::setCameraType",
			"unknown camera type!");
#endif
}
...
// Use: virtual public
void
MyViewer::setViewing(SbBool flag)
//
////////////////////////////////////////////////////////////////////////
{
    if (flag == viewingFlag)
...
// Use: virtual public
void
MyViewer::setCursorEnabled(SbBool flag)
//
////////////////////////////////////////////////////////////////////////
{
...
// Use: public
void
MyViewer::setAutoClipping(SbBool flag)
//
////////////////////////////////////////////////////////////////////////
{
...
// Use: virtual public
void
MyViewer::setStereoViewing(SbBool flag)
//
////////////////////////////////////////////////////////////////////////
{
...
//
void
MyViewer::setHeadlight(SbBool insertFlag)
//
////////////////////////////////////////////////////////////////////////
{
    ...
    if (!fullPath) {
#if DEBUG
	SoDebugError::post("MyViewer::setHeadlight",
...
MyViewer::setDrawStyle(
	    MyViewer::DrawType type, MyViewer::DrawStyle style)
//
////////////////////////////////////////////////////////////////////////
{
...
#ifdef DEBUG
	    SoDebugError::post("MyViewer::setDrawStyle", 
...
// Use: private
void
MyViewer::setCurrentDrawStyle(MyViewer::DrawStyle style)
//
////////////////////////////////////////////////////////////////////////
{
    if (style != VIEW_AS_IS)
...
#ifdef DEBUG
	    SoDebugError::post("MyViewer::setCurrentDrawStyle", "VIEW_SAME_AS_STILL was passed !");
#endif
	    break;
    }
...
// Use: public
MyViewer::DrawStyle
MyViewer::getDrawStyle(MyViewer::DrawType type)
//
////////////////////////////////////////////////////////////////////////
{
...
// Use: virtual public
void
MyViewer::setNormalVisual(XVisualInfo *vis)
//
////////////////////////////////////////////////////////////////////////
{
    // call parent class
...
//  MyViewer::setBufferingType() method which is a superset.
//
//  Use: virtual public
//
void
MyViewer::setDoubleBuffer(SbBool flag)
//
////////////////////////////////////////////////////////////////////////
{
    setBufferingType(flag ? MyViewer::BUFFER_DOUBLE : MyViewer::BUFFER_SINGLE);
}
...
// Use: virtual public
void
MyViewer::setBufferingType(MyViewer::BufferType type)
//
////////////////////////////////////////////////////////////////////////
{
    if (bufferType == type)
	...
	removeStartCallback(MyViewer::bufferStartCallback);
	removeFinishCallback(MyViewer::bufferFinishCallback);
    }
	...
	case BUFFER_INTERACTIVE:
	    SoXtRenderArea::setDoubleBuffer(FALSE);
	    addStartCallback(MyViewer::bufferStartCallback);
	    addFinishCallback(MyViewer::bufferFinishCallback);
	    break;
    }
}
...
void
MyViewer::setSeekMode(SbBool flag)
//
////////////////////////////////////////////////////////////////////////
{
    if (!isViewing())
...
////////////////////////////////////////////////////////////////////////
{
    ...
    if (! useTexture)
	setDrawStyle(MyViewer::INTERACTIVE, MyViewer::VIEW_NO_TEXTURE);
}
...
// Use: protected
SbBool
MyViewer::processCommonEvents(XAnyEvent *xe)
//
////////////////////////////////////////////////////////////////////////
{
    KeySym keysym;
...
SbBool
MyViewer::seekToPoint(const SbVec2s &mouseLocation)
//
////////////////////////////////////////////////////////////////////////
{
    if (camera == NULL) {
...
void
MyViewer::computeSeekFinalOrientation()
//
////////////////////////////////////////////////////////////////////////
{
    SbMatrix mx;
...
void
MyViewer::interpolateSeekAnimation(float t)
//
////////////////////////////////////////////////////////////////////////
{
    if (camera == NULL)
...
void
MyViewer::adjustCameraClippingPlanes()
//
////////////////////////////////////////////////////////////////////////
{
    if (camera == NULL)
...
//
void
MyViewer::copyView(Time eventTime)
//
////////////////////////////////////////////////////////////////////////
{
    if (camera == NULL)
...
//
void
MyViewer::pasteView(Time eventTime)
//
////////////////////////////////////////////////////////////////////////
{
    if (clipboard == NULL)
    ...
    clipboard->paste(eventTime, MyViewer::pasteDoneCB, this);
}
...
//
void 
MyViewer::pasteDoneCB(void *userData, SoPathList *pathList)
//
////////////////////////////////////////////////////////////////////////
{
    SoCamera *newCamera = NULL;
    ...
    if (newCamera != NULL)
	((MyViewer *) userData)->changeCameraValues(newCamera);
...
//
void 
MyViewer::changeCameraValues(SoCamera *newCamera)
//
////////////////////////////////////////////////////////////////////////
{
    if (camera == NULL)
...
////////////////////////////////////////////////////////////////////////
{
...
#ifdef DEBUG
	SoDebugError::post("MyViewer::toggleCameraType", "unknown camera type!");
#endif
	return;
    }
	...
	SoDebugError::post("MyViewer::toggleCameraType", "camera not found!");
#endif
...
//
void
MyViewer::arrowKeyPressed(KeySym key)
//
////////////////////////////////////////////////////////////////////////
{
    if (camera == NULL)
...
void
MyViewer::bufferStartCallback(void *, MyViewer *v)
{
    v->SoXtRenderArea::setDoubleBuffer(TRUE);
}

void
MyViewer::bufferFinishCallback(void *, MyViewer *v)
{
    v->SoXtRenderArea::setDoubleBuffer(FALSE);
}

void
MyViewer::drawStyleStartCallback(void *, MyViewer *v)
{
...
void
MyViewer::drawStyleFinishCallback(void *, MyViewer *v)
{
...
//
void
MyViewer::seekAnimationSensorCB(void *p, SoSensor *)
//
////////////////////////////////////////////////////////////////////////
{
    MyViewer *v = (MyViewer *)p;
...
//
void
MyViewer::setFeedbackOrthoProjection(const SbVec2s &size)
//
////////////////////////////////////////////////////////////////////////
{
...
//
void
MyViewer::restoreGLStateAfterFeedback()
//
////////////////////////////////////////////////////////////////////////
{
...
//
void
MyViewer::drawViewerCrossFeedback(SbVec2s loc)
//
////////////////////////////////////////////////////////////////////////
{
    LIGHT_COLOR;
...
//
void
MyViewer::drawViewerRollFeedback(SbVec2s center, SbVec2s loc)
//
////////////////////////////////////////////////////////////////////////
{
