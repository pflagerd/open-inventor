...
enum ThingsToDo {
	SWITCH_PALETTE, BRING_NEW_DIALOG, CREATE_NEW_PALETTE, SAVE_AS_PALETTE,
};
...
static MenuButtonItemStruct fileData[] = { { "New...", FILE_NEW, "Alt <Key> n",
		"Alt+n" }, { "Save", FILE_SAVE, "Alt <Key> s", "Alt+s" }, {
		"Save As...", FILE_SAVE_AS, "Alt Shift <Key> s", "Alt+S" }, { "Reset",
		FILE_RESET, "Alt <Key> r", "Alt+r" }, { "Delete", FILE_DELETE,
		"Alt <Key> d", "Alt+d" }, };

static MenuButtonItemStruct editData[] = { { "Cut", EDIT_CUT, "Alt <Key> x",
		"Alt+x" }, { "Copy", EDIT_COPY, "Alt <Key> c", "Alt+c" }, { "Paste",
		EDIT_PASTE, "Alt <Key> v", "Alt+v" }, { "Delete", EDIT_DELETE,
		"<Key> BackSpace", "BckSp" }, };
...
// private
//
void MyMaterialPalette::constructorCommon(const char *dir, SbBool buildNow)
//
//////////////////////////////////////////////////////////////////////
		{
	int i;
...
//
// Use: public
void MyMaterialPalette::deselectCurrentItem()
//
////////////////////////////////////////////////////////////////////////
{
	if (selectedItem == -1)
...
//
// Use: private
void MyMaterialPalette::updateWindowTitle()
//
////////////////////////////////////////////////////////////////////////
{
	char str[150];
...
//
// Use: protected
Widget MyMaterialPalette::buildWidget(Widget parent)
//
////////////////////////////////////////////////////////////////////////
		{
...
//
// Use: private
Widget MyMaterialPalette::buildMenu(Widget parent)
//
////////////////////////////////////////////////////////////////////////
		{
	int n, id;
...
//
// Use: private
Widget MyMaterialPalette::buildPaletteMenuEntry(int id)
//
////////////////////////////////////////////////////////////////////////
		{
...
//
// Use: private
void MyMaterialPalette::buildPaletteSubMenu()
//
////////////////////////////////////////////////////////////////////////
{
...
//
// Use: private
void MyMaterialPalette::menuCB(Widget w, int id, XmAnyCallbackStruct *cb)
//
////////////////////////////////////////////////////////////////////////
		{
...
//
// Use: private
void MyMaterialPalette::createSceneGraph()
//
////////////////////////////////////////////////////////////////////////
{
	SoInput in;
...
//
// Use: private
void MyMaterialPalette::getPaletteNamesAndLoad()
//
////////////////////////////////////////////////////////////////////////
{
...
//
// Use: private
void MyMaterialPalette::loadPaletteItems()
//
////////////////////////////////////////////////////////////////////////
{
	...
	if ((dirp = opendir(palDir)) != NULL) {
		...
		while ((direntry = readdir(dirp)) && num < 35) {
			f = direntry->d_name;
			SoNode* mat = getMaterialFromFile(f);
			if (mat) {
...
//
// Use: private
SbBool MyMaterialPalette::handleEvent(XAnyEvent *xe)
//
////////////////////////////////////////////////////////////////////////
		{
	switch (xe->type) {
...
//
// Use: private
void MyMaterialPalette::findCurrentItem(int x, int y)
//
////////////////////////////////////////////////////////////////////////
		{
...
//
// Use: private
void MyMaterialPalette::updateOverlayFeedback()
//
////////////////////////////////////////////////////////////////////////
{
	int row, col;
...
//
// Use: private
void MyMaterialPalette::updateMaterialName()
//
////////////////////////////////////////////////////////////////////////
{
	char *str =
...
//
// Use: private
void MyMaterialPalette::updateEditMenu()
//
////////////////////////////////////////////////////////////////////////
{
...
//
// Use: private
void MyMaterialPalette::updateFileMenu()
//
////////////////////////////////////////////////////////////////////////
{
...
//
// Use: private
void MyMaterialPalette::createNewPalette(char *palName)
//
////////////////////////////////////////////////////////////////////////
		{
	//
...
//
// Use: private
void MyMaterialPalette::createSaveDialog()
//
////////////////////////////////////////////////////////////////////////
{
	Arg args[5];
...
//
// Use: private
void MyMaterialPalette::savePaletteAs(char *palName)
//
////////////////////////////////////////////////////////////////////////
		{
	//
...
//
// Use: private
void MyMaterialPalette::savePalette()
//
////////////////////////////////////////////////////////////////////////
{
	int i;
...
//
// Use: private
void MyMaterialPalette::switchPalette()
//
////////////////////////////////////////////////////////////////////////
{
...
//
// Use: private
void MyMaterialPalette::deleteCurrentMaterial()
//
////////////////////////////////////////////////////////////////////////
{
...
SbBool MyMaterialPalette::raEventCB(void *p, XAnyEvent *xe) {
...
//
void MyMaterialPalette::saveDialogCB(Widget dialog, MyMaterialPalette *p,
...
//
void MyMaterialPalette::deleteDialogCB(Widget dialog, MyMaterialPalette *p,
		XmAnyCallbackStruct *cb) {
...
// dialog get pressed.
//
void MyMaterialPalette::promptDialogCB(Widget dialog, MyMaterialPalette *p,
		XmAnyCallbackStruct *cb) {
	if (cb->reason == XmCR_OK) {
...
// callbaks.
//
void MyMaterialPalette::matEditorCB(void *pt, MySimpleMaterialEditor *ed) {
...
//  popup menu.
//
void MyMaterialPalette::paletteMenuCB(Widget w, int num, void *) {
	// get the class pointer
	MyMaterialPalette *p;
	XtVaGetValues(w, XmNuserData, &p, NULL);
...
//
void MyMaterialPalette::pasteDone(void *pt, SoPathList *pathList) {
	MyMaterialPalette *p = (MyMaterialPalette *) pt;
