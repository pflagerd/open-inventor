...
enum TileDrawStyle {
	DRAW_NORM, DRAW_CURRENT, DRAW_SELECTED,
};
...
static char hourglass_bits[] = {  };
...
// constructor
//
MyTextureEditor::MyTextureEditor(Widget parent, const char *name,
...
//
// Use: public
void MyTextureEditor::setObjectGeometry(SoNode *newGeom)
//
////////////////////////////////////////////////////////////////////////
		{
//???alain
...
//
// Use: public
void MyTextureEditor::setTextureNode(const SoTexture2 *node)
//
////////////////////////////////////////////////////////////////////////
		{
	// copies values over
...
//
// Use: public
void MyTextureEditor::setTransformNode(const SoTexture2Transform *node)
//
////////////////////////////////////////////////////////////////////////
		{
	// copies values over
...
//
// Use: public
void MyTextureEditor::setFunctionNode(const SoTextureCoordinateFunction *node)
//
////////////////////////////////////////////////////////////////////////
		{
	// make our local func node reflect the given node
	SoNode *newFunc =
			(node != NULL) ? node->copy() : new SoTextureCoordinateDefault;
...
//
// Use: protected
Widget MyTextureEditor::buildWidget(Widget parent)
//
////////////////////////////////////////////////////////////////////////
		{
	int n;
	...
	colWheel->addValueChangedCallback(MyTextureEditor::colWheelCB, this);
	Widget wheelW = colWheel->getWidget();

	colSlider = new MyColorSlider(form, NULL, TRUE,
			MyColorSlider::VALUE_SLIDER);
	colSlider->setNumericFieldVisible(FALSE);
	colSlider->setSize(SbVec2s(1, 23));
	colSlider->addValueChangedCallback(MyTextureEditor::colSliderCB, this);
	colSlider->setWYSIWYG(TRUE);
	Widget sliderW = colSlider->getWidget();

	viewer = new SoXtExaminerViewer(form, NULL, TRUE,
			SoXtFullViewer::BUILD_NONE);
...
//
// Use: private
Widget MyTextureEditor::buildMenu(Widget parent)
//
////////////////////////////////////////////////////////////////////////
		{
	Arg args[8];
...
//
// Use: private
Widget MyTextureEditor::buildPaletteMenuEntry(int id)
//
////////////////////////////////////////////////////////////////////////
		{
...
//
// Use: private
void MyTextureEditor::buildPaletteSubMenu()
//
////////////////////////////////////////////////////////////////////////
{
...
//
// Use: private
Widget MyTextureEditor::buildTexturePaletteWidget(Widget parent)
//
////////////////////////////////////////////////////////////////////////
		{
	Arg args[12];
	...
	XtAddEventHandler(glx,
			(PointerMotionMask | ButtonPressMask | ButtonReleaseMask
					| LeaveWindowMask),
			FALSE, (XtEventHandler) MyTextureEditor::glxEventCB,
			(XtPointer) this);
...
//
// Use: private
Widget MyTextureEditor::buildSliders(Widget parent)
//
////////////////////////////////////////////////////////////////////////
		{
	int i, n, num;
...
#define CREATE_SCALE(ID) \
	...
	scaleXThumb->addValueChangedCallback(MyTextureEditor::scaleXThumbCB, this);

	scaleYThumb = new MyThumbWheel(form);
	scaleYThumb->setSize(SbVec2s(100, 21));
	scaleYThumb->addValueChangedCallback(MyTextureEditor::scaleYThumbCB, this);
...
//
// Use: private
Widget MyTextureEditor::buildButtons(Widget parent)
//
////////////////////////////////////////////////////////////////////////
		{
...
//
// Use: private
void MyTextureEditor::redrawPalette()
//
////////////////////////////////////////////////////////////////////////
{
	if (!isVisible())
...
//
// Use: private
void MyTextureEditor::drawTextureTile(int id, int style)
//
////////////////////////////////////////////////////////////////////////
		{
	if (id < 0)
...
//
// Use: private
void MyTextureEditor::updateTextureName()
//
////////////////////////////////////////////////////////////////////////
{
	char *str =
...
//
// Use: private
void MyTextureEditor::updateTextureNode()
//
////////////////////////////////////////////////////////////////////////
{
	if (selectedItem < 0)
...
//
// Use: private
void MyTextureEditor::updateTexture2UI()
//
////////////////////////////////////////////////////////////////////////
{
	...
	XtVaSetValues(widgetList[OPT_PULLDOWN], XmNmenuHistory, widgetList[ID],
			NULL);
}
...
//
// Use: private
void MyTextureEditor::updateTextureXfUI()
//
////////////////////////////////////////////////////////////////////////
{
...
//
// Use: private
void MyTextureEditor::updateTextureFuncUI()
//
////////////////////////////////////////////////////////////////////////
{
	// update the option menu
	...
	if (texFuncNode->isOfType(SoTextureCoordinateDefault::getClassTypeId()))
		ID = MAP_DEFAULT;
	else if (texFuncNode->isOfType(
			SoTextureCoordinateEnvironment::getClassTypeId()))
		ID = MAP_ENV;
	else if (texFuncNode->isOfType(
			SoTextureCoordinatePlane::getClassTypeId())) {
		SbVec3f directionS =
				((SoTextureCoordinatePlane *) texFuncNode)->directionS.getValue();
		SbVec3f directionT =
				((SoTextureCoordinatePlane *) texFuncNode)->directionT.getValue();
		if (directionS == SbVec3f(1, 0, 0) && directionT == SbVec3f(0, 1, 0))
			ID = MAP_PLANE_XY;
		else if (directionS == SbVec3f(1, 0, 0)
				&& directionT == SbVec3f(0, 0, 1))
			ID = MAP_PLANE_XZ;
		else if (directionS == SbVec3f(0, 1, 0)
				&& directionT == SbVec3f(0, 0, 1))
			ID = MAP_PLANE_YZ;
	}
	XtVaSetValues(widgetList[MAPP_PULLDOWN], XmNmenuHistory, widgetList[ID],
			NULL);
}
...
//
// Use: private
SbBool MyTextureEditor::setRepeatState(SbBool flag)
//
////////////////////////////////////////////////////////////////////////
		{
	if (repeatState == flag)
...
//
// Use: private
void MyTextureEditor::updateTextureFieldAndSlider(int fieldID)
//
////////////////////////////////////////////////////////////////////////
		{
	float val;
...
//
// Use: private
void MyTextureEditor::getPaletteNames()
//
////////////////////////////////////////////////////////////////////////
{
...
//
// Use: private
void MyTextureEditor::savePalette()
//
////////////////////////////////////////////////////////////////////////
{
...
//
// Use: private
void MyTextureEditor::loadPaletteItems()
//
////////////////////////////////////////////////////////////////////////
{
	if (curPalette == -1)
	...
	if (cursor == 0) {
		...
		Pixmap source = XCreateBitmapFromData(display, d, hourglass_bits,
				hourglass_width, hourglass_height);
		cursor = XCreatePixmapCursor(display, source, source, &foreground,
				&foreground, hourglass_x_hot, hourglass_y_hot);
	...
	if ((dirp = opendir(palDir)) != NULL) {
		...
		if (pal->user) {
			...
			if ((file = fopen(pal->name, "r")) != NULL) {
				...
				while (fscanf(file, " %s ", fullName) != EOF
						&& num < (IMAGE_TOTAL - 1)) {
...
//
// Use: private
SbBool MyTextureEditor::readScaledImage(char *file, int xsize, int ysize,
		char *buf, int &zsize)
//
////////////////////////////////////////////////////////////////////////
		{
...
//
// Use: private
void MyTextureEditor::switchPalette(int id)
//
////////////////////////////////////////////////////////////////////////
		{
	curPalette = id;
...
//
// Use: private
void MyTextureEditor::deselectCurrentItem(SbBool drawHighlight)
//
////////////////////////////////////////////////////////////////////////
		{
	if (selectedItem == -1)
	...
	if (drawHighlight) {
		glXMakeCurrent(getDisplay(), XtWindow(widgetList[TEXTURE_GLX]),
				paletteCtx);
...
//
// Use: private
void MyTextureEditor::deleteTextureEntry(int id)
//
////////////////////////////////////////////////////////////////////////
		{
	if (textureNames[id].name != NULL)
...
//
// Use: private
SbBool MyTextureEditor::addTextureEntry(int id, char *fullName)
//
////////////////////////////////////////////////////////////////////////
		{
...
//
// Use: private
void MyTextureEditor::updateWindowTitle()
//
////////////////////////////////////////////////////////////////////////
{
	char str[150];
...
//
// Use: private
void MyTextureEditor::handleEvent(XAnyEvent *xe)
//
////////////////////////////////////////////////////////////////////////
		{
	switch (xe->type) {
...
//
// Use: private
void MyTextureEditor::createNewDialog()
//
////////////////////////////////////////////////////////////////////////
{
	Arg args[5];
...
//
// Use: private
void MyTextureEditor::updateFileMenu()
//
////////////////////////////////////////////////////////////////////////
{
	PaletteStruct *pal = (PaletteStruct *) paletteList[curPalette];
...
//
// Use: private
void MyTextureEditor::createNewPalette(char *palName)
//
////////////////////////////////////////////////////////////////////////
		{
	//
...
//
// Use: private
void MyTextureEditor::redrawImageDialog()
//
////////////////////////////////////////////////////////////////////////
{
...
//
// Use: private
void MyTextureEditor::setNewDialogImage(char *fileName)
//
////////////////////////////////////////////////////////////////////////
		{
	...
	if (fileName != NULL) {
		...
		dialogImage = readImage(fileName, dialogImageSize[0],
				dialogImageSize[1], dialogImageSize[2]);
		if (dialogImage != NULL) {

			// resize the glx window
			XtVaSetValues(widgetList[DIALOG_IMAGE], XmNwidth,
					dialogImageSize[0],
			...
			SoXt::createSimpleErrorDialog(widgetList[DIALOG_WINDOW],
					"File Error", str);
		}
	}
	...
	if (dialogImageName == NULL)
		...
		XtVaSetValues(widgetList[DIALOG_IMAGE], XmNwidth, 1, XmNheight, 1,
				NULL);
...
//
// Use: private
void MyTextureEditor::openImageDialog()
//
////////////////////////////////////////////////////////////////////////
{
	...
	XtAddCallback(buttons[0], XmNactivateCallback,
			(XtCallbackProc) MyTextureEditor::imageDialogOpenCB,
			(XtPointer) this);
	XtAddCallback(buttons[1], XmNactivateCallback,
			(XtCallbackProc) MyTextureEditor::imageDialogClearCB,
			(XtPointer) this);
	XtAddCallback(buttons[2], XmNactivateCallback,
			(XtCallbackProc) MyTextureEditor::imageDialogApplyCB,
			(XtPointer) this);
	XtAddCallback(buttons[3], XmNactivateCallback,
			(XtCallbackProc) MyTextureEditor::imageDialogCloseCB,
			(XtPointer) this);
	...
	XtUninstallTranslations(glx);
	XtAddCallback(glx, GLwNginitCallback,
			(XtCallbackProc) MyTextureEditor::imageDialogInitCB,
			(XtPointer) this);
	XtAddCallback(glx, GLwNexposeCallback,
			(XtCallbackProc) MyTextureEditor::imageDialogExposeCB,
			(XtPointer) this);
...
void MyTextureEditor::fieldChangedCB(Widget, MyTextureEditor *p, void *) {
	p->fieldChanged = TRUE;
}

void MyTextureEditor::glxExposeCB(Widget, MyTextureEditor *p, void *) {
	if (p->loadedPalette)
		p->redrawPalette();
	else
...
void MyTextureEditor::glxInitCB(Widget glx, MyTextureEditor *p, void *) {
...
void MyTextureEditor::glxEventCB(Widget, MyTextureEditor *p, XAnyEvent *xe,
		Boolean *) {
	p->handleEvent(xe);
}

void MyTextureEditor::imageDialogExposeCB(Widget, MyTextureEditor *p, void *) {
	p->redrawImageDialog();
}

void MyTextureEditor::imageDialogInitCB(Widget glx, MyTextureEditor *p,
		void *) {
	// create a GLX context
	XVisualInfo *vis;
	XtVaGetValues(glx, GLwNvisualInfo, &vis, NULL);
...
void MyTextureEditor::imageDialogClearCB(Widget, MyTextureEditor *p, void *) {
	p->setNewDialogImage(NULL);
}

void MyTextureEditor::imageDialogCloseCB(Widget, MyTextureEditor *p, void *) {
	SoXt::hide(p->widgetList[DIALOG_WINDOW]);
}

void MyTextureEditor::acceptCB(Widget, MyTextureEditor *p, void *) {
...
//
void MyTextureEditor::colWheelCB(void *pt, const float hsv[3]) {
...
//
void MyTextureEditor::colSliderCB(void *pt, float) {
	MyTextureEditor *p = (MyTextureEditor *) pt;
	if (p->ignoreCallback)
		return;
...
//
void MyTextureEditor::scaleXThumbCB(void *pt, float val) {
	MyTextureEditor *p = (MyTextureEditor *) pt;
...
//
void MyTextureEditor::scaleYThumbCB(void *pt, float val) {
	MyTextureEditor *p = (MyTextureEditor *) pt;
...
//
void MyTextureEditor::fieldsCB(Widget w, int id, void *) {
	...
	XmProcessTraversal(SoXt::getShellWidget(p->getWidget()),
			XmTRAVERSE_CURRENT);
}
...
//
void MyTextureEditor::slidersCB(Widget w, int id, void *) {
	// get the class pointer
	MyTextureEditor *p;
	XtVaGetValues(w, XmNuserData, &p, NULL);
...
//
void MyTextureEditor::mappingMenuCB(Widget w, int id, void *) {
	// get the class pointer
	MyTextureEditor *p;
	XtVaGetValues(w, XmNuserData, &p, NULL);
...
//
void MyTextureEditor::optionMenuCB(Widget w, int id, void *) {
	// get the class pointer
	MyTextureEditor *p;
	XtVaGetValues(w, XmNuserData, &p, NULL);
...
//
void MyTextureEditor::fileMenuCB(Widget w, int id, void *) {
	// get the class pointer
	MyTextureEditor *p;
	XtVaGetValues(w, XmNuserData, &p, NULL);
	...
	case FILE_DELETE:
		p->createDeleteDialog("Delete Palette Dialog",
				...
				"(list of texture files will be lost)");
		break;
	}
}
...
//  popup menu.
//
void MyTextureEditor::paletteMenuCB(Widget w, int num, void *) {
	// get the class pointer
	MyTextureEditor *p;
	XtVaGetValues(w, XmNuserData, &p, NULL);
...
//
void MyTextureEditor::deleteDialogCB(Widget dialog, MyTextureEditor *p,
	...
	if (cb->reason == XmCR_OK) {
		...
		char palDir[MAXPATHLEN];
		sprintf(palDir, "%s/%s/%s", getenv("HOME"), customTextureDir,
				pal->name);
		unlink(palDir);
...
// gets pressed.
//
void MyTextureEditor::newDialogCB(Widget dialog, MyTextureEditor *p,
		XmAnyCallbackStruct *cb) {
	if (cb->reason == XmCR_OK) {
...
//
void MyTextureEditor::imageDialogDestroyCB(Widget, MyTextureEditor *p, void *) {
...
//
void MyTextureEditor::imageDialogOpenCB(Widget, MyTextureEditor *p, void *) {
...
//
void MyTextureEditor::fileDialogOkCB(Widget, MyTextureEditor *p,
...
//
void MyTextureEditor::imageDialogApplyCB(Widget, MyTextureEditor *p, void *) {
	if (p->selectedItem == -1)
		return;
	...
	if (p->dialogImageName != NULL) {
		if (txt->fullName == NULL
				|| strcmp(p->dialogImageName, txt->fullName) != 0) {
			// add the new texture
