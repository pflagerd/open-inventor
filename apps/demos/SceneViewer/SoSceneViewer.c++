...
#define _ATOM_(DISPLAY,NAME) (XmInternAtom(DISPLAY, (char*)NAME, False))
...
//
static void logoCB(void *, SoAction *action) {
	if (action->isOfType(SoGLRenderAction::getClassTypeId())) {
		glViewport(0, 0, 80, 80);
	}
}

static void setOverlayLogo(SoXtRenderArea *ra) {
...
//
SoSceneViewer::SoSceneViewer(Widget parent, const char *name,
		SbBool buildInsideParent, SoSelection *inputGraph, const char *envFile) :
...
// private
//
void SoSceneViewer::constructorCommon(SoSelection *inputGraph,
		const char *envFile, SbBool buildNow)
//
////////////////////////////////////////////////////////////////////////
		{
	int i;
...
//
// Use: private
void SoSceneViewer::switchToViewer(SvEViewer newViewer)
//
////////////////////////////////////////////////////////////////////////
		{
	...
	newVwr->setDrawStyle(SoXtViewer::STILL,
			currentViewer->getDrawStyle(SoXtViewer::STILL));
	newVwr->setDrawStyle(SoXtViewer::INTERACTIVE,
	...
	for (int m = 0; m < maniplist->getLength(); m++) {
		...
		if (manip->isOfType(SoTabBoxManip::getClassTypeId())) {
			...
			newVwr->addFinishCallback(&SoSceneViewer::adjustScaleTabSizeCB,
					manip->getDragger());
		}
	}
...
////////////////////////////////////////////////////////////////////////
{
	...
	if (pickPath->getNode(parentIndex) == selection) {
		fprintf(stderr,
				"No more parents to pick (cannot pick above the selection node)\n");
		return;
	}
...
void SoSceneViewer::replaceAllManips(SvEManipMode manipMode)// Current manipulator
//
////////////////////////////////////////////////////////////////////////
		{
	detachManipFromAll();
...
void SoSceneViewer::attachManipToAll(SvEManipMode manipMode)// Current manipulator
//
////////////////////////////////////////////////////////////////////////
		{
	int i;
...
void SoSceneViewer::attachManip(SvEManipMode manipMode,	// Current manipulator
	...
	if (theXfManip) {
		...
		if (manipMode == SV_TABBOX) {
			...
			currentViewer->addFinishCallback(
					&SoSceneViewer::adjustScaleTabSizeCB,
					theXfManip->getDragger());
		}
		if (manipMode == SV_JACK) {
			...
			d->setPartAsPath("translator.yzTranslator.translatorActive", jackP);
			d->setPartAsPath("translator.xzTranslator.translatorActive", jackP);
			d->setPartAsPath("translator.xyTranslator.translatorActive", jackP);
			jackP->unref();
		}
	}
...
//
// Use: private
void SoSceneViewer::detachManipFromAll()
//
////////////////////////////////////////////////////////////////////////
{
	//
...
void SoSceneViewer::detachManip(SoPath *p)// Selection object that is being removed
//
////////////////////////////////////////////////////////////////////////
		{
	//
...
//
// Use: public
void SoSceneViewer::adjustScaleTabSizeCB(void *userData, SoXtViewer *)
//
////////////////////////////////////////////////////////////////////////
		{
...
//
// Use: public
void SoSceneViewer::viewSelection()
//
////////////////////////////////////////////////////////////////////////
{
...
//
// Use: private
void SoSceneViewer::createColorEditor()
//
////////////////////////////////////////////////////////////////////////
{
	if (colorEditor == NULL) {
...
//
SoMaterial *
SoSceneViewer::findMaterialForAttach(const SoPath *target)// path to start search from
//
////////////////////////////////////////////////////////////////////////
		{
	int pathLength;
	...
	if (selectionPath->getTail()->isOfType(SoBaseKit::getClassTypeId())) {
		...
		SoBaseKit *kit =
				(SoBaseKit *) ((SoNodeKitPath *) selectionPath)->getTail();
	...
	SbBool isTailGroup =
			selectionPath->getTail()->isOfType(SoGroup::getClassTypeId())
					&& (!selectionPath->getTail()->isOfType(
	...
	if (editMtl->ambientColor.isIgnored() || editMtl->diffuseColor.isIgnored()
...
// Use: private
//
SoCallbackAction::Response SoSceneViewer::findMtlPreTailCB(void *data,
		SoCallbackAction *accum, const SoNode *)
//
////////////////////////////////////////////////////////////////////////
		{
	...
	accum->getMaterial(ambient, diffuse, specular, emissive, shininess,
			transparency);
...
//
SoPath *
SoSceneViewer::findTransformForAttach(const SoPath *target)	// path to start search from
//
////////////////////////////////////////////////////////////////////////
		{
	int pathLength;
	...
	if (isTailKit) {
		...
		if ((editXform = SO_GET_PART(kit, "transform", SoTransform)) != NULL) {
			pathToXform = kit->createPathToPart("transform", TRUE,
					selectionPath);
			pathToXform->ref();
		} else {
	...
	if (existedBefore == FALSE) {
		...
		bboxAction.setResetPath(pathToXform, TRUE,
...
//
// Use: private
void SoSceneViewer::createMaterialEditor()
//
////////////////////////////////////////////////////////////////////////
{
...
//
// Use: private
void SoSceneViewer::createTransformSliderSet()
//
////////////////////////////////////////////////////////////////////////
{
	...
	editTransform =
			(SoTransform *) ((SoFullPath *) editTransformPath)->getTail();
...
//
// Use: private
void SoSceneViewer::setFog(SbBool flag)
//
////////////////////////////////////////////////////////////////////////
		{
	fogFlag = flag;
...
//
// Use: private
void SoSceneViewer::setAntialiasing(SbBool flag)
//
////////////////////////////////////////////////////////////////////////
		{
...
void SoSceneViewer::editAmbientColor()
//
////////////////////////////////////////////////////////////////////////
{
...
//  Use: static, private
//
void SoSceneViewer::ambientColorCallback(void *userData, const SbColor *color)
//
////////////////////////////////////////////////////////////////////////
		{
...
void SoSceneViewer::editBackgroundColor()
//
////////////////////////////////////////////////////////////////////////
{
...
//  Use: static, private
//
void SoSceneViewer::backgroundColorCallback(void *userData, const SbColor *c)
//
////////////////////////////////////////////////////////////////////////
		{
	...
	for (int i = paths.getLength() - 1; i >= 0; i--) {
		...
		if (p->getTail()->isOfType(SoSceneKit::getClassTypeId())) {
			...
			SoNodeKitListPart *camList =
					(SoNodeKitListPart *) sceneKit->getPart("cameraList",
							FALSE);
			if (camList && camNum >= 0) {
				SoCameraKit *camKit = (SoCameraKit *) camList->getChild(camNum);
				if (camKit)
...
//
// Use: private
void SoSceneViewer::setLastSceneKitCamera(SoGroup *root, SoCamera *theCam)
//
////////////////////////////////////////////////////////////////////////
		{
	// Find scene kits under the root node and loop backwards:
...
//
// Use: private
void SoSceneViewer::switchOffSceneKitCameras(SoGroup *root)
//
////////////////////////////////////////////////////////////////////////
		{
	// [a] find scene kits if under the root node.
...
//
// Use: private
void SoSceneViewer::restoreSceneKitCameras(SoGroup *root)
//
////////////////////////////////////////////////////////////////////////
		{
	// [a] find scene kits if under the root node.
...
//
// Use: private
void SoSceneViewer::setCameraFields(SoCamera *fromCam)
//
////////////////////////////////////////////////////////////////////////
		{
...
//
// Use: private
void SoSceneViewer::removeCameras(SoGroup *root)
//
////////////////////////////////////////////////////////////////////////
		{
	SoSearchAction sa;
...
//
// Use: private
SbBool SoSceneViewer::readFile(const char *filename)
//
////////////////////////////////////////////////////////////////////////
		{
...
//
// Use: private
SbBool SoSceneViewer::readEnvFile(const char *filename)
//
////////////////////////////////////////////////////////////////////////
		{
	SoInput in;
	...
	if (isValid) {
		...
		if (SoDB::read(&in, n) != FALSE && (n != NULL)) {
			...
			if (n->isOfType(SoCamera::getClassTypeId())) {
				...
				if (fullCamPath) {
					SoGroup *parent = (SoGroup *) fullCamPath->getNode(
							fullCamPath->getLength() - 2);
					parent->insertChild(newCamera,
							parent->findChild(oldCamera));
					setCamera(newCamera);
		...
		if (SoDB::read(&in, n) != FALSE && (n != NULL)) {
			...
			if (n->isOfType(SoDirectionalLight::getClassTypeId())) {
				...
				if (headlight != NULL) {
					headlight->intensity.setValue(
							newLight->intensity.getValue());
					headlight->color.setValue(newLight->color.getValue());
					headlight->direction.setValue(
							newLight->direction.getValue());
					setHeadlight(TRUE);
				}
			}
			n->unref();
...
//
// Use: private
void SoSceneViewer::getFileName()
//
////////////////////////////////////////////////////////////////////////
{
	...
	if (fileDialog == NULL) {
		...
		n++;
		fileDialog = XmCreateFileSelectionDialog(XtParent(mgrWidget),
				(char*)"File Dialog", args, n);

		XtAddCallback(fileDialog, XmNokCallback,
				(XtCallbackProc) SoSceneViewer::fileDialogCB, (XtPointer) this);
	}
...
//
void SoSceneViewer::fileDialogCB(Widget, SoSceneViewer *sv,
...
////////////////////////////////////////////////////////////////////////
	...
	// Get the file name
	char *filename;
	XmStringGetLtoR(data->value, (XmStringCharSet) XmSTRING_DEFAULT_CHARSET,
			&filename);
...
//
// Use: private
void SoSceneViewer::deleteScene()
//
////////////////////////////////////////////////////////////////////////
{
...
//
// Use: private
SbBool SoSceneViewer::doFileIO(const char *file)
//
////////////////////////////////////////////////////////////////////////
		{
	SbBool okFile = TRUE;
...
//
// Use: private
void SoSceneViewer::removeAttachedLightManipGeometry()
//
////////////////////////////////////////////////////////////////////////
{
	for (int i = 0; i < lightDataList.getLength(); i++) {
...
//
// Use: private
void SoSceneViewer::addAttachedLightManipGeometry()
//
////////////////////////////////////////////////////////////////////////
{
	for (int i = 0; i < lightDataList.getLength(); i++) {
...
//
// Use: private
SbBool SoSceneViewer::writeFile(const char *filename)
//
////////////////////////////////////////////////////////////////////////
		{
	SoWriteAction wa;
...
//
// Use: private
SbBool SoSceneViewer::writeEnvFile(const char *filename)
//
////////////////////////////////////////////////////////////////////////
		{
	SoWriteAction wa;
...
////////////////////////////////////////////////////////////////////////
{
	if (printDialog == NULL) {
		...
		printDialog->setBeforePrintCallback(SoSceneViewer::beforePrintCallback,
				(void *) this);
		printDialog->setAfterPrintCallback(SoSceneViewer::afterPrintCallback,
				(void *) this);
	}
...
//
// Use: private
void SoSceneViewer::removeManips()
//
////////////////////////////////////////////////////////////////////////
{
	// temporarily replace all manips with regular transform nodes.
...
//
// Use: private
void SoSceneViewer::restoreManips()
//
////////////////////////////////////////////////////////////////////////
{
	// Now put the manips back in the scene graph.
...
//
// Use: private, static
void SoSceneViewer::beforePrintCallback(void *uData, SoXtPrintDialog *)
//
////////////////////////////////////////////////////////////////////////
		{
...
//
// Use: private, static
void SoSceneViewer::afterPrintCallback(void *uData, SoXtPrintDialog *)
//
////////////////////////////////////////////////////////////////////////
		{
	SoSceneViewer *sv = (SoSceneViewer *) uData;
...
// Use: private, static
//
void SoSceneViewer::processTopbarEvent(Widget,	// Which widget?  I don't care
...
////////////////////////////////////////////////////////////////////////
	...
	case SV_MANIP_TRANSFORMER:
		...
		sv->curManip =
				(sv->curManip == SV_TRANSFORMER) ? SV_NONE : SV_TRANSFORMER;
	...
	case SV_MANIP_CENTERBALL:
		sv->highlightRA->setVisible(FALSE); // highlight visible when no manip
		sv->curManip =
				(sv->curManip == SV_CENTERBALL) ? SV_NONE : SV_CENTERBALL;
		if (sv->curManipReplaces)
			sv->replaceAllManips(sv->curManip);
		break;
	...
	case SV_LIGHT_ADD_DIRECT:
		sv->addLight(new SoDirectionalLightManip);
		break;
	case SV_LIGHT_ADD_POINT:
		sv->addLight(new SoPointLightManip);
		break;
...
// Use: private
//
void SoSceneViewer::addLight(SoLight *light)
//
////////////////////////////////////////////////////////////////////////
		{
	...
	SbVec3f center = vwrCamera->position.getValue()
			+ forward
					* (vwrCamera->nearDistance.getValue()
							+ vwrCamera->farDistance.getValue()) / 2.0;
...
////////////////////////////////////////////////////////////////////////
	...
	if (calculatedLightManipSize == FALSE && oldScale != SbVec3f(1, 1, 1)) {
...
// Use: private
//
void SoSceneViewer::addLightMenuEntry(SvLightData *data)
//
////////////////////////////////////////////////////////////////////////
		{
	//
...
#endif
	data->submenuWidget = XmCreatePulldownMenu(menu, (char*)"submenu", args, argnum);
	...
	data->cascadeWidget = XtCreateWidget(data->name, xmCascadeButtonGadgetClass,
			menu, args, 1);

	// add "on/off" toggle
	data->onOffWidget = XtCreateWidget((char*)"On/Off", xmToggleButtonGadgetClass,
	...
	// add "Icon" toggle
	data->iconWidget = XtCreateWidget((char*)"Icon", xmToggleButtonGadgetClass,
			data->submenuWidget, NULL, 0);
	XtAddCallback(data->iconWidget, XmNvalueChangedCallback,
			(XtCallbackProc) SoSceneViewer::editLightToggleCB,
			(XtPointer) data);

	// add "Edit Color" toggle
	data->editColorWidget = XtCreateWidget((char*)"Edit Color",
			xmPushButtonGadgetClass, data->submenuWidget, NULL, 0);
	XtAddCallback(data->editColorWidget, XmNactivateCallback,
			(XtCallbackProc) SoSceneViewer::editLightColorCB, (XtPointer) data);

	// add "Remove" entry
	data->removeWidget = XtCreateWidget((char*)"Remove", xmPushButtonGadgetClass,
			data->submenuWidget, NULL, 0);
...
// Use: static private
//
void SoSceneViewer::lightToggleCB(Widget toggle, SvLightData *data, void *)
//
////////////////////////////////////////////////////////////////////////
		{
...
// Use: private
//
void SoSceneViewer::turnLightOnOff(SvLightData *data, SbBool flag)
//
////////////////////////////////////////////////////////////////////////
		{
...
// Use: static private
//
void SoSceneViewer::editLightToggleCB(Widget toggle, SvLightData *data, void *)
//
////////////////////////////////////////////////////////////////////////
		{
...
// Use: private
//
void SoSceneViewer::editLight(SvLightData *data, SbBool flag)
//
////////////////////////////////////////////////////////////////////////
		{
		...
		if (forHeadlight) {
			...
			if (path != NULL) {
				...
				if (dataType.isDerivedFrom(ptLightType)) {
					...
					newLight->ref();
					((SoPointLightManip *) data->light)->replaceManip(path,
							(SoPointLight *) newLight);
				} else if (dataType.isDerivedFrom(dirLightType)) {
					...
					newLight->ref();
					((SoSpotLightManip *) data->light)->replaceManip(path,
							(SoSpotLight *) newLight);
				}
				path->unref();
				data->light->unref();
				data->light = newLight;
...
// Use: private
//
void SoSceneViewer::transferDirectionalLightLocation(SvLightData *data)
//
////////////////////////////////////////////////////////////////////////
		{
	if (!data->light)
	...
	SoDirectionalLightManip *manip = (SoDirectionalLightManip *) data->light;
...
// Use: static private
//
void SoSceneViewer::editLightColorCB(Widget, SvLightData *data, void *)
//
////////////////////////////////////////////////////////////////////////
		{
...
// Use: static private
//
void SoSceneViewer::removeLightCB(Widget, SvLightData *data, void *)
//
////////////////////////////////////////////////////////////////////////
		{
...
// Use: private
//
void SoSceneViewer::removeLight(SvLightData *data)
//
////////////////////////////////////////////////////////////////////////
		{
...
// Use: private
//
void SoSceneViewer::calculateLightManipSize()
//
////////////////////////////////////////////////////////////////////////
{
	// Set the size for the light manips.
...
// Use: static private
//
void SoSceneViewer::lightSubmenuDisplay(Widget, SvLightData *data, void *)
//
////////////////////////////////////////////////////////////////////////
		{
	SoSceneViewer *sv = data->classPt;
...
// Use: static, private
//
void SoSceneViewer::pasteDoneCB(void *userData, SoPathList *pathList)
//
////////////////////////////////////////////////////////////////////////
		{
	SoSceneViewer *sv = (SoSceneViewer *) userData;
...
// Use: static, private
//
SbBool SoSceneViewer::iconDropCB(void *userData, const char *filename)
//
////////////////////////////////////////////////////////////////////////
		{
	SoSceneViewer *sv = (SoSceneViewer *) userData;
...
// Use: static, private
//
SbBool SoSceneViewer::objDropCB(void *userData, Atom target, void *data,
		uint32_t numBytes)
//
////////////////////////////////////////////////////////////////////////
		{
...
// Use: private
//
void SoSceneViewer::pasteDone(SoPathList *pathList)
//
////////////////////////////////////////////////////////////////////////
		{
	...
	selection->removeDeselectionCallback(SoSceneViewer::deselectionCallback,
			this);
...
Widget SoSceneViewer::buildWidget(Widget parent)
//
////////////////////////////////////////////////////////////////////////
		{
	int n;
	...
	mgrWidget = XtCreateWidget(getWidgetName(), xmFormWidgetClass, parent, args,
			n);
	...
	MyDropSite::registerCallback(mgrWidget, iconDropCB, objDropCB, this);
...
//
// Use: private
void SoSceneViewer::buildAndLayoutViewer(SoXtFullViewer *vwr)
//
////////////////////////////////////////////////////////////////////////
		{
	if (mgrWidget == NULL)
	...
	if (vwr->getWidget() == NULL) {
		fprintf(stderr,
				"ERROR - need to create the viewer widget before it can be layed out\n");
		return;
	}
	...
	if (showMenuFlag) {
		...
		n++;
		XtSetArg(args[n], XmNtopWidget, menuWidget);
		n++;
	} else {
...
// Use: private
//
void SoSceneViewer::buildAndLayoutMenu(Widget parent)
//
////////////////////////////////////////////////////////////////////////
		{
	if (menuWidget != NULL)
	...
	// create topbar menu
	menuWidget = XmCreateMenuBar(parent, (char*)"menuBar", NULL, 0);
	...
	for (i = 0; i < itemCount; i++) {
		...
		Widget subMenu = XmCreatePulldownMenu(menuWidget, (char*)"subMenu", popupargs,
				popupn);
		...
		for (j = 0; j < subItemCount; j++) {
			if (pulldownData[i].subMenu[j].buttonType == SV_SEPARATOR)
				...
				default:
					fprintf(stderr,
							"SceneViewer INTERNAL ERROR: bad buttonType\n");
					break;
				}
				...
				subButtons[j] = XtCreateWidget(pulldownData[i].subMenu[j].name,
...
//
// Use: public
void SoSceneViewer::showMenu(SbBool flag)
//
////////////////////////////////////////////////////////////////////////
		{
...
//  Use: private, static
//
void SoSceneViewer::deselectionCallback(void *userData,	   	     // my data
...
//  Use: private, static
//
void SoSceneViewer::selectionCallback(void *userData,		 // my data
...
////////////////////////////////////////////////////////////////////////
	...
	if (sv->transformSliderSet && sv->transformSliderSet->isVisible()) {
		...
		if (editTransformPath == NULL) {
			...
			editTransformPath->ref();
			sv->transformSliderSet->setNode(
					((SoFullPath *) editTransformPath)->getTail());
			editTransformPath->unref();
		}
	}
...
//  Use: protected
//
void SoSceneViewer::destroySelectedObjects()
//
////////////////////////////////////////////////////////////////////////
{
	for (int i = selection->getNumSelected() - 1; i >= 0; i--) {
...
//
// 
void SoSceneViewer::updateCommandAvailability()
//
////////////////////////////////////////////////////////////////////////
{
	Arg args[1];
...
//  Use: static private
//
void SoSceneViewer::menuDisplay(Widget, SoSceneViewerData *data, XtPointer)
//
////////////////////////////////////////////////////////////////////////
		{
	SoSceneViewer *sv = data->classPt;
...
// Use: static, public
//
SbBool SoSceneViewer::isAffectedByTransform(SoNode *theNode)// node to be affected?
//
////////////////////////////////////////////////////////////////////////
		{
...
// Use: static, public
//
SbBool SoSceneViewer::isAffectedByMaterial(SoNode *theNode)	// node to be affected?
//
////////////////////////////////////////////////////////////////////////
		{
	if (theNode->isOfType(SoGroup::getClassTypeId())
...
// Use: private
//
void SoSceneViewer::showAboutDialog()
//
////////////////////////////////////////////////////////////////////////
{
